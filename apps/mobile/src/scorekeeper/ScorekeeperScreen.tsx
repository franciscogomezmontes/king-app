...
import { Button, HandCountField, Scoreboard, ScoreboardEntry, colors, fonts, layout, spacing, typography, useTranslation } from "ui-kit";
        ...
        <View style={[styles.content, { maxWidth: layout.maxContentWidth }]}>
          ...
          <View style={styles.entryBar}>
            ...
            {handType === "positive" && (
              <Pressable
                style={styles.toggle}
                onPress={() => setDirection(state.draftDirection === "up" ? "down" : "up")}
              >
